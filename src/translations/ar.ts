const translations = {
  ...
  "profile.picture.success": "تم تحديث صورة ملفك الشخصي بنجاح.",
  "profile.username.updated": "تم تحديث اسم المستخدم",
  "profile.username.success": "تم تحديث اسم المستخدم الخاص بك بنجاح.",
  "profile.email.updated": "تم تحديث البريد الإلكتروني",
  "profile.email.success": "تم تحديث عنوان بريدك الإلكتروني بنجاح.",
  "profile.edit.username": "تعديل اسم المستخدم",
